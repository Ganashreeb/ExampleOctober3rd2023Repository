...
public class GhybridSuperConstructorOverloading 
{
	public static void main(String[] args) {
		
		System.out.println("Product Info");
		System.out.println();
		Purchase p=new Purchase("P1","Dell", 48580,"Electronics", 10);
		p.displayProdinfo();
		p.diplaypurchseinfo();
		System.out.println("*******");
		...
		System.out.println();
		Sales s=new Sales("P2", "HP", 46580, "Electronics", 20, "Ord001");
		s.displayProdinfo();
		s.diplayorderinfo();
		s.displayorder();
